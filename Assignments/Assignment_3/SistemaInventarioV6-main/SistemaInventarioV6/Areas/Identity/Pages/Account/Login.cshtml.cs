    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var user = await _unidadTrabajo.AppUser.ObtenerPrimero(u=>u.Email == Input.Email);
                    var cartList = await _unidadTrabajo.ShoppingCart.ObtenerTodos(c => c.AppUserId == user.Id);
