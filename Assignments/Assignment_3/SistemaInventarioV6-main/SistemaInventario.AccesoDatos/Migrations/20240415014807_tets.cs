        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    myUsername = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    security_question = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    security_answer = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Code = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Processor = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountCode = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessorCards", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ProcessorCards_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_ProcessorCards_PaymentProcessors_ProcessorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_Prices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Prices",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessorCards_CardId",
                table: "ProcessorCards",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessorCards_ProcessorId",
                table: "ProcessorCards",
                column: "ProcessorId");
